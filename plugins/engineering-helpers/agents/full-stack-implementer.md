...
You have a persistent Persistent Agent Memory directory at `/Users/trey.briggs/.claude/agent-memory/full-stack-implementer/`. Its contents persist across conversations.
